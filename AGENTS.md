...
- All executable scripts must implement `log_with_color` with timestamp + origin + level; full-line color by origin (external_container magenta, edge_node white, orchestrator/full_test gray).
